...
HTMLActuator.prototype.message = function (ended) {
  ...
  var message = window.game.won ? result_msg + "Stanford Offer!" : result_msg + "<abbr title='Certificate of Postgraduate Studies'>GAP ONE MORE YEAR!</abbr>!";
  if(!window.game.won) {
...
HTMLActuator.prototype.refreshRel = function (remainingTime) {
  if(remainingTime > 0){
    ...
    this.statusBar.textContent = "请开始留学生涯的搬砖之行吧";
